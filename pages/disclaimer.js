const disclaimer = () => {
  return (
    <div className="text-center">
      ...
      <p>
        The information provided by <b>BloodForAll</b> (“Company”, “we”, “our”,
        “us”) on <b>https://bloodforall.life</b> (the “Site”) is for general
      ...
      <p>
        The Site can not and does not contain medical advice. The information is
        provided for general informational and educational purposes only and is
        not a substitute for professional medical advice. Accordingly, before
      ...
      <p>
        Content published on https://bloodforall.life is intended to be used and
        ...
        circumstances. You should take independent medical advice from a
      ...
      <p>
        ...
        BloodForAll is not responsible for any errors or omissions or for the
      ...
      <p>
        In no event will BloodForAll, its related partnerships or corporations,
      ...
      <p>
        ...
        https://bloodforall.life are the trademarks and logos of their
